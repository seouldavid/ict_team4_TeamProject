...
//    private String  keyword;
    ...
    public AdmHosPagingVO(int totalCnt, Integer page) {
        this(totalCnt, new SearchVO(page, 10));
    }

    public AdmHosPagingVO(int totalCnt, Integer page, Integer pageSize) {
        this(totalCnt, new SearchVO(page, pageSize));
    }

    public AdmHosPagingVO(int totalCnt, SearchVO sc) {

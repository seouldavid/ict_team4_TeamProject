...
public class BoardVO {
	private String admin_answer, wr_id, bbs_id, group_id, wr_subject,	wr_content,	answer_at, parent_id, answer_lc, sort_ordr,	rdcnt, use_at, start_dt, end_dt, mber_id, mber_nm, password, atch_file_id, old_atch_file_id, h_id, h_score,	crt_by,	crt_dt,	upd_by,	upd_dt, wr_active;
	private String notice_top;
	private String wr_couns_ans;
	...
	public String getWr_couns_ans() {
		return wr_couns_ans;
	}

	public void setWr_couns_ans(String wr_couns_ans) {
		this.wr_couns_ans = wr_couns_ans;
	}

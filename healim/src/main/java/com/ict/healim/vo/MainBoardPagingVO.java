...
public class MainBoardPagingVO {
    private SearchVO sc;
...
//    private String  keyword;
    ...
    public MainBoardPagingVO(int totalCnt, Integer page) {
        this(totalCnt, new SearchVO(page, 10));
    }

    public MainBoardPagingVO(int totalCnt, Integer page, Integer pageSize) {
        this(totalCnt, new SearchVO(page, pageSize));
    }

    public MainBoardPagingVO(int totalCnt, SearchVO sc) {
    ...
    private void doPaging(int totalCnt, SearchVO sc) {
    ...
    public SearchVO getSc() {
        return sc;
    }

    public void setSc(SearchVO sc) {
        this.sc = sc;
    }
